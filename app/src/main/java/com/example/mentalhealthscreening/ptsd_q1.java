...
public class ptsd_q1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ptsd_q1);

        // Initialize UI elements
        questionTextView = findViewById(R.id.ptsd_q1);
...
//                    currentQuestionIndex++;
                    ...
                    Intent intent = new Intent(ptsd_q1.this, ptsd_q2.class);
