...
public class ocd_q5 extends AppCompatActivity {
...
//    private int currentQuestionIndex = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ocd_q5);

        // Initialize UI elements
        questionTextView = findViewById(R.id.ocd_q5);
...
//                    currentQuestionIndex++;
                    ...
                    Intent intent = new Intent(ocd_q5.this, Results.class);
