...
public class insomnia_q1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insomnia_q1);

        // Initialize UI elements
        questionTextView = findViewById(R.id.insomnia_q1);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (selectedAnswerId != -1) {
                    ...
                    Intent intent = new Intent(insomnia_q1.this, insomnia_q2.class);
