...
public class insomnia_q3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insomnia_q3);

        // Initialize UI elements
        questionTextView = findViewById(R.id.insomnia_q3);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (selectedAnswerId != -1) {
                    ...
                    Intent intent2 = new Intent(insomnia_q3.this, insomnia_q4.class);
