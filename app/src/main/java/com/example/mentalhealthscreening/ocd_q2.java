...
public class ocd_q2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ocd_q2);

        // Initialize UI elements
        questionTextView = findViewById(R.id.ocd_q2);
...
//                    int user_Score = intent.getIntExtra("user_score", 0);

//                    String scoreText = String.valueOf(user_Score);
//                    useruser.setText(scoreText);


                    Intent intent2 = new Intent(ocd_q2.this, ocd_q3.class);
