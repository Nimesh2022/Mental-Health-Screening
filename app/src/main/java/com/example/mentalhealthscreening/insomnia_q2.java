...
public class insomnia_q2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insomnia_q2);

        // Initialize UI elements
        questionTextView = findViewById(R.id.insomnia_q2);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (selectedAnswerId != -1) {
                    ...
                    Intent intent2 = new Intent(insomnia_q2.this, insomnia_q3.class);
